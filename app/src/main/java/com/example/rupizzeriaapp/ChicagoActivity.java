...
public class ChicagoActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        size = findViewById(R.id.chicagoSize);  
        image = findViewById(R.id.chicagoImage);
        flavors = findViewById(R.id.chicagoflavors);
        //flavors spinner
        ...
        //toppings recycler
        recyclerAdd = findViewById(R.id.toppingsAvailible);
        toppingsAvailible = new ArrayList<>();
        setToppingAvailible();
        setToppingAvailibleAdapter();
        recyclerRemove = findViewById(R.id.toppingsRemove);
        toppingsSelected = new ArrayList<>();
        setToppingSelectedAdapter();
        price = findViewById(R.id.chicagoPrice);
    }
    ...
    public void onItemSelected(AdapterView<?> adapterView,
        ...
        if(selected.equals("Build Your Own")) {
            image.setImageResource(R.drawable.chicagobuild);
    ...
    public void placeOrder(View view){
        ...
        if(sizeID == -1)
            ...
            Log.i("Chicago", currentOrder.toString());
            //finish();
            Toast.makeText(ChicagoActivity.this,
